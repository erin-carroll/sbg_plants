...
function LinkedQueryPage() {
  ...
  const filterContent = (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, px: 2, pb: 2, pt: isMobile ? 2 : 0, flex: 1, overflowY: 'auto' }}>
      ...
      <Button
        ...
        onClick={() => { q.handleApply(); if (isMobile) setMobileFilterOpen(false); }}
        disabled={q.loading}
        fullWidth
      >
        Apply
